...
Synthesize inbox, calendar, team, and project signals into a prioritized daily brief.
...
`0 7 * * 1-5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect gmail, googlecalendar, slack.
