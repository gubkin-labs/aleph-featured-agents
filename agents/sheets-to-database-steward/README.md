# Sheets-to-Database Steward

## Outcome

Validate spreadsheet rows and preview database upserts before approval.
...
`0 6 * * *` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect googlesheets, supabase.
