# Spec-to-Task Planner

## Outcome

Convert approved specifications into reviewable implementation task drafts.
...
`0 9 * * 1` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect notion, confluence, linear.
