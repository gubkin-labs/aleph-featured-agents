...
Prepare structured sales-to-success handoffs with risks, promises, and next steps.
...
`0 16 * * 1-5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect hubspot, notion, slack.
