...
Extract objections and coaching opportunities from sales calls and preview CRM updates.
...
`0 17 * * 5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect gong, fathom, hubspot.
