# Cross-System Data Auditor

## Outcome

Detect cross-system drift and generate a reconciliation plan without mutating records.
...
`0 7 * * 1` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect googlesheets, hubspot, asana.
