...
2. Add a least-privilege `GH_TOKEN` to that scope's vault. It needs read access
   to `gubkin-labs/project10` and contents/pull-request write access only to
   `gubkin-labs/project10-frontend`.
