...
Transform source content into reviewable channel-specific campaign drafts.
...
`0 10 * * 1` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect googledocs, notion, linkedin.
