...
Assemble source material into a validated newsletter draft.
...
`0 9 * * 2` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect googledocs, notion, mailchimp.
