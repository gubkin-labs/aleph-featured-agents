# Meeting Follow-up Chief

## Outcome

Turn meeting records into decisions, Notion notes, and follow-up email drafts.
...
`0 17 * * 1-5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect fathom, notion, gmail.
