# Partner Update Composer

## Outcome

Prepare recurring partner updates from CRM facts and approved workspace notes.
...
`0 9 * * 5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect hubspot, notion.
