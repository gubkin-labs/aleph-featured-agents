# Campaign Launch Coordinator

## Outcome

Check campaign readiness and prepare launch communications and remediation tasks.
...
`0 8 * * 1-5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect asana, slack, mailchimp.
