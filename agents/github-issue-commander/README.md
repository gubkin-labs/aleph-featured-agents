# GitHub Issue Commander

## Outcome

Deduplicate and prioritize GitHub issues, then prepare Linear work and a team digest.
...
`0 9 * * 1-5` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect github, linear, slack.
