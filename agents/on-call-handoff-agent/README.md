...
Prepare concise handoffs from active incidents, alerts, and unresolved risks.
...
`0 6,18 * * *` in UTC. Scheduled runs are read-only and produce reports or drafts only. Change or remove the schedule after cloning as needed.
...
1. Clone the agent and connect pagerduty, sentry, slack.
